...
var vtprotoPool_PostalAddress = sync.Pool{
	New: func() interface{} {
		return &PostalAddress{}
	},
}

func (m *PostalAddress) ResetVT() {
	if m != nil {
		f0 := m.AddressLines[:0]
		f1 := m.Recipients[:0]
		m.Reset()
...
func (m *PostalAddress) ReturnToVTPool() {
	if m != nil {
		m.ResetVT()
		vtprotoPool_PostalAddress.Put(m)
	}
}
func PostalAddressFromVTPool() *PostalAddress {
	return vtprotoPool_PostalAddress.Get().(*PostalAddress)
}
